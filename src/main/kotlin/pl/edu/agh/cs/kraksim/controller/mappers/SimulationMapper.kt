...
@Mapper(uses = [SimulationStateMapper::class, MapMapper::class, MovementSimulationStrategyMapper::class, LightStateMapper::class], injectionStrategy = InjectionStrategy.CONSTRUCTOR)
